			...
			<div>
				<ul>
					<NavLink
						className={({ isActive }) => {
							return isActive
								? "font-mono text-xl bg-neutral/70 px-4 mx-1  py-2 rounded-xl text-white font-normal "
								: "font-bold font-mono text-xl hover:bg-neutral/30 text-primary px-4 mx-1  py-2 rounded-xl hover:text-white hover:font-normal"
						}}
						to="/"
					>
						Home
			...
			<div className="flex items-center">
				...
				{user ? (
					<button
						...
						className="font-bold text-xl font-mono bg-secondary text-white px-4 mx-1 py-2 rounded-xl"
					>
						Log out
					</button>
				) : (
