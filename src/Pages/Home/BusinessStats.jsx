	...
	return (
		<div name="about" className="w-full my-32">
			...
			<div class="md:mt-14 mt-4 relative sm:flex items-center justify-center">
				...
				<div class="shadow-lg xl:p-6 p-4 sm:w-auto w-full bg-white dark:bg-gray-800 sm:absolute relative z-20 sm:mt-0 mt-4 left-0 xl:ml-56 sm:ml-12 xl:-mt-40 ">
				...
				<div class="shadow-lg xl:p-6 p-4 w-full sm:w-auto bg-white dark:bg-gray-800 sm:absolute relative z-20 sm:-mt-48 mt-4 xl:-mt-80  xl:-ml-0 sm:-ml-12">
					<p class="text-3xl font-semibold text-gray-800 dark:text-white">
						{totalUsers}
					</p>
					<p class="text-base leading-4 xl:mt-4 mt-2 text-gray-600 dark:text-gray-200">
				...
				<div class="shadow-lg xl:p-6 p-4 sm:w-auto w-full bg-white dark:bg-gray-800  sm:absolute relative z-20 md:mt-0 sm:-mt-5 mt-4 right-0 xl:mr-56 sm:mr-24">
					<p class="text-3xl font-semibold text-gray-800 dark:text-white">
						{totalReviees}+
					</p>
					<p class="text-base leading-4 xl:mt-4 mt-2 text-gray-600 dark:text-gray-200">
